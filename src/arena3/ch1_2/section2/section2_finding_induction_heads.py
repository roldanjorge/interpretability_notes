...
from eindex import eindex  # type: ignore[import-untyped]
...
from src.arena3.ch1_2.plotly_utils import (
...
def run_and_cache_model_repeated_tokens(
    ...
    """
    rep_tokens = generate_repeated_tokens(model, seq_len=seq_len)
...
def get_log_probs(
    ...
    return correct_logprobs  # type: ignore[no-any-return]
